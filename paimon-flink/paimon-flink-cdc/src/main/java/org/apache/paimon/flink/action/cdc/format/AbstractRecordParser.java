...
public abstract class AbstractRecordParser
    ...
    public Schema buildSchema(CdcSourceRecord record) {
        try {
            ...
            return recordOpt.map(RichCdcMultiplexRecord::schema).orElse(null);
        } catch (Exception e) {
    ...
    protected void evalComputedColumns(Map<String, String> rowData, Schema.Builder schemaBuilder) {
    ...
    protected RichCdcMultiplexRecord createRecord(
            RowKind rowKind, Map<String, String> data, Schema.Builder schemaBuilder) {
